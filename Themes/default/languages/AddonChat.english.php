...
$txt['AddonChat_allow_avatar'] = 'Integrate users avatars into the chat?';
$txt['AddonChat_allow_avatar_sub'] = 'If enable, the user\'s avatars will be used in the chat, this feature isn\'t available for some chat versions';
$txt['AddonChat_show_chatusers_menu'] = 'Show the number of active chat users on the Chat button';
$txt['AddonChat_show_chatusers_menu_sub'] = 'If enable, it will show the number of active chat users on the Chat button in the main menu.';
$txt['AddonChat_show_chatusers_boardIndex'] = 'Show the active chat users on the BoardIndex';
$txt['AddonChat_show_chatusers_boardIndex_sub'] = 'If enable, it will show the number of active chat users as a list on the BoardIndex.';
$txt['AddonChat_show_chatusers_boardIndex_rooms_sub'] = 'If the above setting is set, would you like to show  the room where the user in on the chat?';
$txt['AddonChat_show_chatusers_boardIndex_rooms'] = 'This will show the actual room name, for example:  username on room name'; 
...
$txt['permissionname_AddonChat_can_mod_chat'] = 'Will appear as red in the Chat';
