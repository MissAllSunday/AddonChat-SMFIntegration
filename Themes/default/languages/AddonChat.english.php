...
$txt['permissionname_AddonChat_show_chatusers_menu'] = 'Show the number of active chat users on the Chat button';
$txt['permissionname_AddonChat_show_chatusers_menu_sub'] = 'If enable, it will show the number of active users on the chat on the Chat button in the main menu.';
