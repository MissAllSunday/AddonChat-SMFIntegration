...
$txt['AddonChat_boardIndex_rooms_sub'] = 'If the above setting is set, would you like to show  the room where the user in on the chat?';
$txt['AddonChat_boardIndex_rooms'] = 'This will show the actual room name, for example:  username on room name';
...
$txt['permissionname_AddonChat_can_mod_chat'] = 'User can moderate the chat room';
